<template>
    ...
    <el-card class="mt" v-for="item in alarmList" :key="item.equNo">
        ...
        <el-descriptions :border="true" :column="4" direction="vertical" class="mt">
            ...
            <el-descriptions-item label="操作">
                <el-button @click="drawer = true" :type="item.status === 2 ? 'warning' : 'primary'">{{ item.status === 1
                    ?
                    "指派" : (item.status
                        ===
                        2 ? "催办" : "查看") }}</el-button>
    ...
    <el-drawer v-model="drawer" title='报警任务指派'>
        <StepForm :steps="steps" :form1="form1" :form2="form2" :form3="form3" @handle-submit="handleSubmit">
            <template #step-1>
                <el-form :model="formData.basicInfo" :rules="basicRules" ref="form1">
                    ...
                    <el-form-item label="其他备注信息">
                        <el-input v-model="formData.basicInfo.remarks" type="textarea"></el-input>
                    </el-form-item>
                </el-form>
            </template>
            <template #step-2>
                <el-form :model="formData.checkInfo" ref="form2" :rules="checkInfoRules">
                    <el-form-item label="审批部门" prop="dep1">
                        <el-select placeholder="请选择审批部门" v-model="formData.checkInfo.dep1">
                    ...
                    <el-form-item label="抄送部门" prop="dep2">
                        <el-select placeholder="请选择抄送部门" v-model="formData.checkInfo.dep2">
                            <el-option label="总裁办" value="1"></el-option>
                            <el-option label="运营部" value="2"></el-option>
                            <el-option label="维修部" value="3"></el-option>
                            <el-option label="市场部" value="4"></el-option>
            ...
            <template #step-3>
                <el-form :model="formData.principalInfo" ref="form3" :rules="infoRules">
                    <el-form-item label="负责人姓名" prop="person">
                        <el-input v-model="formData.principalInfo.person"></el-input>
                    </el-form-item>
                    <el-form-item label="负责人电话" prop="tel">
                        <el-input v-model="formData.principalInfo.tel"></el-input>
                    </el-form-item>
                </el-form>
            </template>
        </StepForm>
